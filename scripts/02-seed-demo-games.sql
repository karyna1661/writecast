...
-- Insert fill-in-blank demo games (expires_at is NULL so they never expire)
INSERT INTO games (game_code, author_id, game_type, masterpiece_text, hidden_word, status, total_players, successful_guesses, failed_guesses, expires_at) VALUES
('ABC123', '00000000-0000-0000-0000-000000000001', 'fill-blank', 
 ...
 'innovation', 'active', 47, 32, 15, NULL),
...
('XYZ789', '00000000-0000-0000-0000-000000000001', 'fill-blank',
 ...
 'serendipity', 'active', 38, 22, 16, NULL),
...
('TECH42', '00000000-0000-0000-0000-000000000001', 'fill-blank',
 ...
 'blockchain', 'active', 52, 41, 11, NULL),
...
('WORD99', '00000000-0000-0000-0000-000000000001', 'fill-blank',
 ...
 'metamorphosis', 'active', 29, 15, 14, NULL),
...
('POET88', '00000000-0000-0000-0000-000000000001', 'fill-blank',
 ...
 'ephemeral', 'active', 34, 19, 15, NULL),
...
('SAGE77', '00000000-0000-0000-0000-000000000001', 'fill-blank',
 ...
 'wisdom', 'active', 45, 33, 12, NULL);

-- Insert frame-the-word demo games (expires_at is NULL so they never expire)
INSERT INTO games (game_code, author_id, game_type, masterpiece_text, hidden_word, status, total_players, successful_guesses, failed_guesses, expires_at) VALUES
('FRAME1', '00000000-0000-0000-0000-000000000001', 'frame-word',
 ...
 'resilience', 'active', 41, 28, 13, NULL),
...
('FRAME4', '00000000-0000-0000-0000-000000000001', 'frame-word',
 ...
 'nostalgia', 'active', 44, 31, 13, NULL),
...
('FRAME6', '00000000-0000-0000-0000-000000000001', 'frame-word',
 ...
 'melancholy', 'active', 28, 16, 12, NULL);
